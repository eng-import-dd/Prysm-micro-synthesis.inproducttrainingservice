...
namespace Synthesis.InProductTrainingService
{
    internal static class Program
    {
        ...
        {
            var rootContainer = InProductTrainingServiceBootstrapper.RootContainer;
            ...
            if (args == null || args.Length == 0)
            {
                ...
                if (!string.IsNullOrWhiteSpace(instrumentationKey))
                {
                    ...
                    MicroServiceTelemetryInitializer.Initialize(new MicroServiceTelemetryConfiguration
                    {
                        ...
                        ServiceName = "InProductTrainingService",
                ...
                try
                {
                    ...
                    ServiceRuntime.RegisterServiceAsync("InProductTrainingType",
                        context => new InProductTrainingService(context)).GetAwaiter().GetResult();

                    logger.Info($"ServiceType is registered. ProcessId: {Process.GetCurrentProcess().Id}, Name: {typeof(InProductTrainingService).Name}");
